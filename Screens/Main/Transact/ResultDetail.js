  ...
  return (
    <LinearGradient
      ...
      <Container showsVerticalScrollIndicator={false}>
        <Card1>
          <PlanTitle>Axis Global Equity Alpha FoF(G)- Direct Plan</PlanTitle>
          <NavTitle>NAV As on Feb-23-2024</NavTitle>
          <Amount>Rs. 16.0143</Amount>
          <View
        ...
        <Card2>
          <Meta>FoFs (Overseas)</Meta>
          <MetaLabel>Diversified</MetaLabel>
          <Meta style={{marginTop: 10}}>MSCI WORLD</Meta>
        ...
        <Card4>
          ...
          <InfoRow>
            ...
            <InfoColumn2>
              <InfoValue style={{color: '#13b5ba'}}>Vinayak Jayanath</InfoValue>
            </InfoColumn2>
          </InfoRow>
          <InfoRow>
            <InfoColumn>
        ...
        <Card5>
          ...
          <ReturnRow>
            <ReturnColumn>
              <ReturnLabel>Two Month Return</ReturnLabel>
            </ReturnColumn>
            <ReturnColumn>
              <ReturnValue>-</ReturnValue>
            </ReturnColumn>
          ...
          <ReturnRow>
            <ReturnColumn>
              <ReturnLabel>Five Month Return</ReturnLabel>
            </ReturnColumn>
            <ReturnColumn>
              <ReturnValue>-</ReturnValue>
            </ReturnColumn>
