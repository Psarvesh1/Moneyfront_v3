...
const RStatus = () => {
  ...
  const [selectedLanguage, setSelectedLanguage] = useState('Resident Indian');
        ...
        <Container>
          ...
          <Modal
            ...
            <PickerIOS
              ...
              <PickerIOS.Item label="Resident Indian" value="Resident Indian" />
              <PickerIOS.Item label="NRI-NRE" value="NRI-NRE" />
              <PickerIOS.Item label="NRI-NR0" value="NRI-NRO" />
