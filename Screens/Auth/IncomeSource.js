...
const IncomeSource = () => {
  ...
  const [selectedLanguage, setSelectedLanguage] = useState('Salary');
        ...
        <Container>
          ...
          <Modal
            ...
            <PickerIOS
              ...
              <PickerIOS.Item label="Salary" value="Salary" />
              <PickerIOS.Item label="Business Income" value="Business Income" />
              <PickerIOS.Item label="Gift" value="Gift" />
              <PickerIOS.Item label="Ancestral Property" value="Ancestral Property" />
              <PickerIOS.Item label="Rental Income" value="Rental Income" />
              <PickerIOS.Item label="Prize Money" value="Prize Money" />
              <PickerIOS.Item label="Royalty" value="Royalty" />
              <PickerIOS.Item label="Others" value="Others" />
